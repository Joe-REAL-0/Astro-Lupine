...
namespace AstroLupine.Powers
{
    public class DefenseOverwritePower : CustomPowerModel
    {
        ...
        public override string? CustomPackedIconPath => "res://AstroLupine/assets/texture/power/defense_overwrite.png";
        ...
        public override async Task AfterApplied(Creature? applier, CardModel? cardSource)
        {
            if (this.Owner != null)
            {
                ...
                if (openSource != null)
                {
                    await openSource.TriggerProtocol("Defense", this.Amount);
                }
