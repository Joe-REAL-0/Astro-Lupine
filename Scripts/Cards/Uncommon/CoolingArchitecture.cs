...
namespace AstroLupine.Cards.Uncommon
{
    public class CoolingArchitecture : BaseAstroLupineCard
    {
        ...
        protected override IEnumerable<DynamicVar> CanonicalVars => new DynamicVar[] { new MagicVar(10) };
        ...
        {
            await PowerCmd.Apply<CoolingArchitecturePower>(choiceContext, cardPlay.Card.Owner.Creature, 2, cardPlay.Card.Owner.Creature, this);
        }
